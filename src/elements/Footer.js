                                    ...
                                    <li>
                                        <a href="tel:+919983333334">
                                            <div className="fooCircle">
                                                <img src={window.location.origin + '/img/callicon.svg'} className="img-fluid" />
                                            </div>
                                            <p>+91-9983333334</p>
                                        </a>
                                    </li>
                            ...
                            <ul className="d-flex flex-wrap justify-content-center align-items-center mt-4">
                                ...
                                <li>
                                    <a href='https://api.whatsapp.com/send?phone=919983333334&text=Hello,%20I%20want%20to%20discuss%20my%20project.%20Please%20schedule%20a%20metting.' target="_blank">
                                        <img src={window.location.origin + '/img/whatsappIconw.svg'} className="img-fluid" />
                                    </a>
                                </li>
                                <li>
                                    <a href='skype:vishal.soolanki?chat' target="_blank">
                                        <img src={window.location.origin + '/img/skypeIconw.svg'} className="img-fluid" />
                                    </a>
                                </li>
                            </ul>
